...
class OxygenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_all_oxygens_endpoint = _Endpoint(
            settings={
                'response_type': ([Oxygen],),
                'auth': [
                    'bearer'
        ...
        self.get_last1_oxygen_by_date_between_and_disband_id_endpoint = _Endpoint(
            settings={
                'response_type': (Oxygen,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/oxygens/last/disbandId/{disbandId}',
                'operation_id': 'get_last1_oxygen_by_date_between_and_disband_id',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
        ...
        self.get_oxygen_by_id_endpoint = _Endpoint(
            settings={
                'response_type': (Oxygen,),
                'auth': [
                    'bearer'
    ...
    def get_all_oxygens(
        ...
        **kwargs
        ...
        >>> thread = api.get_all_oxygens(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        kwargs['_request_auths'] = kwargs.get('_request_auths', None)
        return self.get_all_oxygens_endpoint.call_with_http_info(**kwargs)

    def get_last1_oxygen_by_date_between_and_disband_id(
        self,
        min_date,
        max_date,
        disband_id,
        **kwargs
        ...
        """Get last oxygen by disband ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_last1_oxygen_by_date_between_and_disband_id(min_date, max_date, disband_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['disband_id'] = \
            disband_id
        return self.get_last1_oxygen_by_date_between_and_disband_id_endpoint.call_with_http_info(**kwargs)

    def get_oxygen_by_id(
        self,
        id,
        **kwargs
    ):
        ...
        >>> thread = api.get_oxygen_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['id'] = \
            id
        return self.get_oxygen_by_id_endpoint.call_with_http_info(**kwargs)
