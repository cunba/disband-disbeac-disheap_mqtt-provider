...
class UsersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.update_user_email_endpoint = _Endpoint(
            settings={
                'response_type': (HandledResponse,),
                'auth': [
                    'bearer'
                ],
                'endpoint_path': '/users/{id}/email',
                'operation_id': 'update_user_email',
                'http_method': 'PATCH',
                'servers': None,
            },
            params_map={
    ...
    def update_user_email(
        ...
        **kwargs
        ...
        """Update user's email  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_user_email(id, email, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['email'] = \
            email
        return self.update_user_email_endpoint.call_with_http_info(**kwargs)
